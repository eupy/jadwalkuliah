        ...
        <div class="row">
            <div class="col-md-12">
                <div class="page-header text-center mb-4">
                    <h3><i class="fas fa-plus-circle me-2"></i>Tambah Jadwal Kuliah</h3>
                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('kode_mk') is-invalid @enderror"
                                            name="kode_mk" value="{{ old('kode_mk') }}" placeholder="Masukkan Kode MK">
                                        @error('kode_mk')
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('nama_mk') is-invalid @enderror"
                                            name="nama_mk" value="{{ old('nama_mk') }}" placeholder="Masukkan Nama MK">
                                        @error('nama_mk')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('tahun_akademik') is-invalid @enderror"
                                            name="tahun_akademik" value="{{ old('tahun_akademik') }}"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('nama_dosen') is-invalid @enderror"
                                            name="nama_dosen" value="{{ old('nama_dosen') }}" placeholder="Masukkan Nama Dosen">
                                        @error('nama_dosen')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('ruang') is-invalid @enderror"
                                            name="ruang" value="{{ old('ruang') }}" placeholder="Masukkan Ruang">
                                        @error('ruang')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
